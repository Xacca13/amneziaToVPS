...
✅ Модуль скачан: include-urls.list
✅ Модуль скачан: exclude-urls.list
✅ Модуль скачан: filter-urls.list
...
📋 Следующие шаги:
  ...
  4. Split конфиг: /home/user/amnezia/server-clients/client_01.conf
  5. Full конфиг: /home/user/amnezia/server-clients-full/client_01.conf
  6. AdGuard Home: http://185.123.45.67:3000 (закройте порт 3000 после настройки!)
